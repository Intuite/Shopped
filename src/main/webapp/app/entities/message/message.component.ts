...
export class MessageComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.messageService
      ...
      .subscribe(
        (res: HttpResponse<IMessage[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IMessage[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

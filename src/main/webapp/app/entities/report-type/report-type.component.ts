...
export class ReportTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reportTypeService
      ...
      .subscribe(
        (res: HttpResponse<IReportType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IReportType): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInReportTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('reportTypeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IReportType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

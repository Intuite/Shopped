...
export class NotificationTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.notificationTypeService
      ...
      .subscribe(
        (res: HttpResponse<INotificationType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNotificationTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('notificationTypeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: INotificationType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

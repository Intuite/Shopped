...
/**
 * A DTO for the {@link com.intuite.shopped.domain.RecipeTag} entity.
 */
@ApiModel(description = "Tags for recipes.\n@author Isaac Miranda")
public class RecipeTagDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RecipeTagDTO)) {
            return false;
        }

        return id != null && id.equals(((RecipeTagDTO) o).id);
    }

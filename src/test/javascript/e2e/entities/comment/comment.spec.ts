...
describe('Comment e2e test', () => {
  ...
  it('should load Comments', async () => {
    ...
    expect(await commentComponentsPage.getTitle()).to.eq('shoppedApp.comment.home.title');
  ...
  it('should load create Comment page', async () => {
    ...
    expect(await commentUpdatePage.getPageTitle()).to.eq('shoppedApp.comment.home.createOrEditLabel');
  ...
  /* it('should create and save Comments', async () => {
        ...
        await promise.all([
            ...
            commentUpdatePage.statusSelectLastOption(),
  ...
  /* it('should delete last Comment', async () => {
        ...
        expect(await commentDeleteDialog.getDialogTitle())
            .to.eq('shoppedApp.comment.delete.question');

...
export class BiteComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-bite div table .btn-danger'));
  title = element.all(by.css('jhi-bite div h2#page-heading span')).first();
...
export class BiteUpdatePage {
  pageTitle = element(by.id('jhi-bite-heading'));
...
export class BiteDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-bite-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-bite'));

...
import { ReportPostComponent } from 'app/entities/report-post/report-post.component';
...
describe('Component Tests', () => {
  describe('ReportPost Management Component', () => {
    let comp: ReportPostComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReportPostComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reportPosts && comp.reportPosts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

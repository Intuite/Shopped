...
describe('Component Tests', () => {
  describe('RecipeTag Management Component', () => {
    let comp: RecipeTagComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RecipeTagComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.recipeTags && comp.recipeTags[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { BiteComponent } from 'app/entities/bite/bite.component';
import { BiteService } from 'app/entities/bite/bite.service';
import { Bite } from 'app/shared/model/bite.model';

describe('Component Tests', () => {
  describe('Bite Management Component', () => {
    let comp: BiteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BiteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bites && comp.bites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

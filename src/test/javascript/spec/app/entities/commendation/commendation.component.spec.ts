...
import { CommendationComponent } from 'app/entities/commendation/commendation.component';
...
describe('Component Tests', () => {
  describe('Commendation Management Component', () => {
    let comp: CommendationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CommendationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.commendations && comp.commendations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

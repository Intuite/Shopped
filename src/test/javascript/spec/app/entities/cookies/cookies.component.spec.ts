...
import { CookiesComponent } from 'app/entities/cookies/cookies.component';
import { CookiesService } from 'app/entities/cookies/cookies.service';
import { Cookies } from 'app/shared/model/cookies.model';

describe('Component Tests', () => {
  describe('Cookies Management Component', () => {
    let comp: CookiesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CookiesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cookies && comp.cookies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

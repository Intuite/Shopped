...
describe('Component Tests', () => {
  describe('IngredientTag Management Component', () => {
    let comp: IngredientTagComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IngredientTagComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ingredientTags && comp.ingredientTags[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

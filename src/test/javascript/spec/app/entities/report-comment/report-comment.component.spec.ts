...
import { ReportCommentComponent } from 'app/entities/report-comment/report-comment.component';
...
describe('Component Tests', () => {
  describe('ReportComment Management Component', () => {
    let comp: ReportCommentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReportCommentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reportComments && comp.reportComments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

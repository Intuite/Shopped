...
import { LogTypeComponent } from 'app/entities/log-type/log-type.component';
import { LogTypeService } from 'app/entities/log-type/log-type.service';
import { LogType } from 'app/shared/model/log-type.model';

describe('Component Tests', () => {
  describe('LogType Management Component', () => {
    let comp: LogTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LogTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.logTypes && comp.logTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
